...
| Testing  | Vitest + jsdom                                   | 446 unit tests across `utils/` and `api/`.                                                     |
...
**446 unit tests across 33 files** (Vitest + jsdom), concentrated where a silent bug would be
worst:
